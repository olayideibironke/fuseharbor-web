...
const highlights = [
  ...
  "Design-conscious installation experience",
  "Guidance for modern garages and driveways",
  "Built for premium homeowner confidence",
];

const useCases = [
  "New EV owners preparing for everyday home charging",
  "Homeowners upgrading from outlet charging to a dedicated solution",
  "Households planning for multiple EVs over time",
  "Homes needing cleaner charging setup before resale or renovation",
];

const process = [
  "Tell us about your home, vehicle, and charging goals",
  "Get matched for the right installation path",
  "Review next steps around equipment, layout, and scope",
  "Move forward with a cleaner premium homeowner experience",
];
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 pb-16 pt-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:pb-20">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 font-[family-name:var(--font-manrope)] text-5xl font-semibold tracking-[-0.04em] sm:text-6xl">
              Premium home charging starts here
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-fh-stone">
              FuseHarbor is building a cleaner way for homeowners to plan and
              start EV charger installation with trust, clarity, and a more
              premium experience from the very beginning.
            </p>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="mt-4 font-[family-name:var(--font-manrope)] text-3xl font-semibold tracking-tight sm:text-4xl">
              Home charging is one of the most important EV ownership upgrades
            </h2>
            <p className="mt-4 max-w-xl text-base leading-7 text-fh-stone">
              A thoughtful charging setup makes daily life easier, keeps the
              home experience cleaner, and helps homeowners prepare for how
        ...
        <div className="rounded-[36px] border border-fh-linen bg-fh-white p-8 shadow-sm lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <h2 className="mt-4 font-[family-name:var(--font-manrope)] text-3xl font-semibold tracking-tight sm:text-4xl">
                Designed to feel clear from day one
              </h2>
            </div>
        ...
        <div className="rounded-[40px] border border-fh-sand bg-[linear-gradient(135deg,_#f2ebe1_0%,_#e7d9c8_100%)] p-8 shadow-sm lg:p-12">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-4 font-[family-name:var(--font-manrope)] text-3xl font-semibold tracking-tight sm:text-4xl">
                Start your EV charger installation path with confidence
              </h2>
              <p className="mt-4 text-base leading-7 text-fh-stone">
                FuseHarbor is building a more premium homeowner experience for
                modern electrification projects.
              </p>
            </div>
