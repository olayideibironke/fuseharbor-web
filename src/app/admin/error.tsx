...
export default function AdminError({
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <section className="overflow-hidden rounded-[28px] border border-red-100 bg-white/90 shadow-[0_18px_50px_rgba(15,23,42,0.06)] backdrop-blur">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="max-w-2xl text-sm text-slate-600">
                    The page hit an unexpected problem. Use the actions below to retry or return to the main admin dashboard.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-5 px-5 py-5 sm:px-6 sm:py-6">
          <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-1 text-sm text-slate-600">
              Retry this screen first. If the issue continues, return to the dashboard and reopen the workflow from there.
            </p>
          </div>
