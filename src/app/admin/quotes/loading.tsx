    ...
    <div className="space-y-5 sm:space-y-6">
      ...
      <section className="overflow-hidden rounded-[28px] border border-black/5 bg-white/90 shadow-[0_18px_50px_rgba(15,23,42,0.05)]">
        ...
        <div className="space-y-4 p-5 sm:p-6">
          <div className="hidden items-center gap-4 rounded-[20px] border border-slate-200 bg-slate-50/80 px-4 py-3 md:grid md:grid-cols-[1.2fr_1fr_0.8fr_0.8fr_0.8fr]">
          ...
          {Array.from({ length: 5 }).map((_, index) => (
            ...
            >
              <div className="grid gap-4 md:grid-cols-[1.2fr_1fr_0.8fr_0.8fr_0.8fr] md:items-center">
