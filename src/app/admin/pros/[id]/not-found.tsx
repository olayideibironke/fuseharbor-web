...
export default function AdminProDetailNotFound() {
  return (
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h1 className="text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl">
                      Pro application not found
                    </h1>
                    <p className="mt-1 text-sm text-slate-600">
                      This pro application may have been removed, the link may be incomplete, or the ID may be invalid.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="overflow-hidden rounded-[28px] border border-black/5 bg-white/90 shadow-[0_18px_50px_rgba(15,23,42,0.05)]">
        <div className="flex flex-col gap-5 px-5 py-5 sm:px-6 sm:py-6">
          <div className="rounded-[24px] border border-slate-200 bg-slate-50 p-4">
            ...
            <p className="mt-1 text-sm text-slate-600">
              Return to the pros queue to reopen a valid application, or go back to the main admin dashboard.
            </p>
          </div>
