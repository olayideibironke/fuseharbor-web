...
export default async function ForProsSuccessPage({
  searchParams,
}: {
  ...
  const tradeCategory = params.tradeCategory ?? "Professional interest";
        ...
        <div className="grid gap-8 xl:grid-cols-[1.05fr_0.95fr]">
          <div className="space-y-8">
            <div className="rounded-[36px] border border-fh-linen bg-fh-white p-8 shadow-sm lg:p-10">
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-fh-sand text-fh-moss">
              ...
              <div className="mt-8 grid gap-4">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-fh-graphite">
                        We review fit and category
                      </p>
                      <p className="mt-1 text-sm leading-6 text-fh-stone">
                        Your trade category, service area, and positioning are reviewed as the early pro network takes shape.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-[24px] border border-fh-linen bg-fh-warm-white px-5 py-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-fh-graphite">
                        We follow up using your submitted details
                      </p>
                      <p className="mt-1 text-sm leading-6 text-fh-stone">
                        Your contact information is now available for future marketplace follow-up.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-[24px] border border-fh-linen bg-fh-warm-white px-5 py-4">
                  <div className="flex items-start gap-3">
                    <BriefcaseBusiness size={18} className="mt-0.5 shrink-0 text-fh-copper" />
                    <div>
                      <p className="text-sm font-semibold text-fh-graphite">
                        Keep your request reference
                      </p>
                      <p className="mt-1 text-sm leading-6 text-fh-stone">
                        Save the reference below in case you ever need to mention this pro interest later.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="rounded-[24px] border border-fh-linen bg-fh-warm-white px-5 py-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-semibold text-fh-graphite">
                        Premium pro-side review continues
                      </p>
                      <p className="mt-1 text-sm leading-6 text-fh-stone">
                        Your interest is now inside the FuseHarbor workflow as the marketplace keeps becoming more polished and launch-ready.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8">
            <div className="rounded-[36px] border border-fh-sand bg-[linear-gradient(135deg,_#f2ebe1_0%,_#e7d9c8_100%)] p-8 shadow-sm lg:p-10">
              ...
              <h2 className="mt-3 font-[family-name:var(--font-manrope)] text-2xl font-semibold text-fh-graphite">
                Your pro interest reference has been created
              </h2>
              <p className="mt-3 text-sm leading-7 text-fh-stone">
                This is your stable confirmation page for the pro interest submission.
              </p>
            ...
            <div className="rounded-[36px] border border-fh-linen bg-fh-white p-8 shadow-sm lg:p-10">
              ...
              <p className="mt-4 text-base leading-7 text-fh-stone">
                This success page can be refreshed without losing the confirmation state.
              </p>
