    ...
    <main className="min-h-screen bg-fh-warm-white text-fh-graphite">
      <form noValidate onSubmit={handleSubmit}>
        <section className="relative overflow-hidden border-b border-fh-linen/80 bg-[linear-gradient(to_bottom,_#fffdf9,_#f7f4ee)]">
          ...
          <div className="mx-auto max-w-7xl px-6 pb-12 pt-6 lg:px-8 lg:pb-14">
            <p className="text-sm font-semibold tracking-[0.2em] text-fh-copper uppercase">
              Get a quote
            </p>

            <div className="mt-4 grid gap-8 xl:grid-cols-[0.96fr_1.04fr] xl:items-start">
              <div>
              ...
              <div
                id="quote-form"
                className="rounded-[36px] border border-fh-sand bg-[linear-gradient(135deg,_#f2ebe1_0%,_#e7d9c8_100%)] p-8 shadow-sm lg:p-10"
              >
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-fh-white text-fh-copper">
                    <Zap size={22} />
                  </div>
                  <div>
                    <p className="text-sm font-semibold tracking-[0.2em] text-fh-copper uppercase">
                    ...
                    <h2 className="font-[family-name:var(--font-manrope)] text-2xl font-semibold text-fh-graphite">
                ...
                <p className="mt-4 text-base leading-7 text-fh-stone">
                  Start right here. Choose the service that best matches what
                  you are planning for your home.
                </p>
                      ...
                      <button
                        ...
                        className={`rounded-[28px] border p-5 text-left transition ${
                          isSelected
                            ...
                            : "border-fh-linen bg-white/75 hover:border-fh-copper hover:bg-fh-white"
                        }`}
                      >
                        <div
